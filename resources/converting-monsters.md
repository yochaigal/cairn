...
- **Strength** is both health and physical power. Remember to look at the creature's **HD** and **HP** _again_, even if you've already done so for **Hit Protection** above. A creature's health in **Cairn** is better represented by **STR** than by **Hit Protection**; that means that if a creature is difficult to kill but _not_ because they are good avoiding injury, give them more **STR** (not **HP**). **STR** is how long the creature can stay in the fight _after_ getting hit as well as its brute strength. It also tracks their constitution/resistance to poisons.
