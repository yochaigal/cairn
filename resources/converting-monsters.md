...
- **Hit Protection** is _not_ health. It's the creature's ability to avoid danger, whether through toughness, speed, or skill. If the PCs will have a tough time landing a blow that actually causes damage, the creature has high **HP**.
...
- **Strength** is both health and physical power. Sometimes HP/HD from other systems is better represented in **STR** than in **Hit Protection**; if a creature is difficult to kill but _not_ because they are good avoiding injury, give them more **STR**. **STR** is how long the creature can stay in the fight _after_ getting hit as well as its brute strength. It also tracks their constitution.
