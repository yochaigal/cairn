...
|      |                                |                                                              |
| ---- | ------------------------------ | ------------------------------------------------------------ |
| 1    | **Acid Arrow**                 | 1d6 damage now and d6 STR loss next round unless washed.     |
...
| 11   | **Baleful Polymorph**          | WIL Save or Transforms subject into harmless animal.         |
| 12   | **Bear's Endurance**           | Subject has Armour 2.                                        |
| 13   | **Bestow Curse**               | Target automatically fails next Save.                        |
| 14   | **Black Tentacles**            | Tentacles grapple all within 20 ft.                          |
| 15   | **Blight**                     | Withers plants.                                              |
| 16   | **Blindness**                  | WIL Save or blinded.                                         |
| 17   | **Blink**                      | You randomly vanish and reappear, avoiding the next attack against you. |
| 18   | **Blur**                       | Your details cannot be seen.                                 |
| 19   | **Break Enchantment**          | Frees subjects from enchantments, alterations, curses, and petrification. |
| 20   | **Bull's Strength**            | Unarmed melee attacks cause d10 damage.                      |
| 21   | **Burning Hands**              | d8 fire damage.                                              |
| 22   | **Cat's Grace**                | Automatically pass the next DEX Save.                        |
| 23   | **Cause Fear**                 | WIL Save or target flees.                                    |
| 24   | **Charm Monster**              | WIL Save or monster treats you as an ally.                   |
| 25   | **Charm Person**               | Makes one person your friend until they next rest.           |
| 26   | **Chill Touch**                | Lose d4 STR.                                                 |
| 27   | **Clairaudience/Clairvoyance** | Hear or see at a distance.                                   |
