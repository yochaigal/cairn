...
| 2    | **Animate Object**      | [dice] objects obeys your commands as best it can. It can walk 15ft per round. |
| 3    | **Anthropomorphize**    | A touched animal either gains human intelligence or human appearance for [sum] days. |
| 4    | **Arcane Eye**          | You can see through a magical floating eyeball that flies around at your command. |
| 5    | **Astral Prison**       | [dice] objects is frozen in time and space within an invulnerable crystal shell. |
| 6    | **Attract**             | [sum]+1 objects are strongly magnetically attracted to each other if they come within 10 feet. |
| 7    | **Auditory Illusion**   | You create illusory sounds that seem to come from a direction of your choice. |
| 8    | **Babble**              | [dice] creatures must loudly and clearly repeat everything you think. It is otherwise mute. |
| 9    | **Beast Form**          | You and your possessions transform into a mundane animal.    |
| 10   | **Befuddle**            | [sum] creatures of your choice are unable to form new short-term memories for the duration of the spell. |
| 11   | **Bend Fate**           | Roll [dice]+1 d20s. Whenever you must roll a d20 after casting the spell, you must choose and then discard one of the rolled results until they are all gone |
...
| 15   | **Charm**               | [sum] creatures treat you like a friend.                     |
| 16   | **Command**             | A creature obeys a single, [sum] word command that does not harm it |
...
| 20   | **Counterspell**        | Make an opposed Intelligence save against the Intelligence of the caster of a nearby spell. You may do this out of turn as a reaction, or against an ongoing magical effect. On a |
...
| 29   | **Filch**               | [dice] visible items teleport to your hands.                 |
| 30   | **Fog Cloud**           | Dense fog spreads out from you                               |
| 31   | **Frenzy**              | [sum] creatures erupt in a frenzy of violence                |
...
| 39   | **Hypnotize**           | A creature enters a trance and will truthfully answer [dice] yes or no questions you ask it. |
| 40   | **Icy Touch**           | A thick ice layer spreads across a touched surface, up to [dice]×10ft in radius. |
| 41   | **Illuminate**          | A floating light moves as you command.                       |
| 42   | **Increase Gravity**    | The gravity in an area triples.                              |
| 43   | **Invisible Tether**    | Two objects within [dice]x10ft of each other cannot be moved more than [dice]x10ft apart. |
| 44   | **Knock**               | [dice] nearby mundane or magical locks unlock.               |
| 45   | **Leap**                | You can jump up to [dice]×10ft in the air.                   |
| 46   | **Liquid Air**          | The air around you becomes swimmable.                        |
| 47   | **Magic Dampener**      | [dice] nearby magical effects have their effectiveness halved. |
| 48   | **Manse**               | A sturdy, furnished cottage appears for [dice]×12 hours. You can permit and forbid entry to it at will. |
| 49   | **Marble Madness**      | Your pockets are full of marbles, and will refill for [sum] rounds. |
| 50   | **Masquerade**          | [dice] characters’ appearances and voices become identical to a touched character. |
| 51   | **Miniaturize**         | You and [dice] other touched creatures are reduced to the size of a mouse. |
...
| 54   | **Multiarm**            | You gain [dice] extra arms                                   |
| 55   | **Night Sphere**        | An [sum]×40ft wide sphere of darkness displaying the night sky appears. |
...
| 58   | **Pacify**              | [dice] creatures have an aversion to violence.               |
...
| 63   | **Psychometry**         | The referee answers [dice] yes or no questions about a touched object. |
| 64   | **Pull**                | An object of any size is pulled directly towards you with the strength of [sum] men for one round. |
| 65   | **Push**                | An object of any size is pushed directly away from you with the strength of [sum] men for one round. |
| 66   | **Raise Dead**          | [sum] skeletons rise from the ground to serve you. They are incredibly stupid and can only obey simple orders. |
| 67   | **Raise Spirit**        | The spirit of a dead body manifests and will answer [dice] questions. |
| 68   | **Read Mind**           | You can hear the surface thoughts of [dice] nearby creatures. |
| 69   | **Repel**               | [sum]+1 objects are strongly magnetically repelled from each other if they come within 10 feet. |
...
| 76   | **Snail Knight**        | 10 minutes after casting, a knight sitting astride a giant snail rides into view. He is able to answer most questions related to quests and chivalry, and may aid you if he finds |
...
| 82   | **Summon Cube**         | [sum] times per round] you may summon or banish a 3-foot-wide cube of earth. New cubes must be affixed to the earth or to other cubes. |
| 83   | **Summon Idol**         | A carved stone statue the size of a four poster bed rises from the ground. |
...
| 88   | **Thaumaturgic Anchor** | Object becomes the target of [sum] spells cast near it.      |
| 89   | **Thicket**             | A thicket of trees and dense brush up to [sum]×40ft wide suddenly sprouts up. |
| 90   | **Time Jump**           | An object disappears as it jumps [dice]×10 minutes into the future. When it returns, it appears in the unoccupied area nearest to where it left. |
...
| 97   | **Ward**                | A silver circle 40ft across appears on the ground. Choose one thing that cannot cross it |
| 98   | **Web**                 | Your wrists can shoot thick webbing that covers [sum]x10ft.  |
