...
4. If you get doubles of any kind, something has gone very wrong. Roll 1d6 on the **Mishaps** table below and add the digit from the double rolled (e.g. +3 from a pair of 3s). If there are multiple doubles, choose the lowest.
