...
| 6    | [Astral Prison](#astral-prison)         | An object is frozen in time and space within an invulnerable crystal shell. | Crystalline purple binding. Abstract faces stare through a tortoise-shell surface, screaming at the reader noiselessly. |
...
| 15   | [Command](#command)                     | A target obeys a single three-word command that does not cause it harm. | Long-time keepers of this unadorned black volume will gradually detect mysterious whispers emanating from it, asking them to perform odd tasks with seemingly no purpose. They will find it hard to resist, eventually.  |
