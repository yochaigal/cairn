...
**SAVES**   
- Roll *1d20* equal to or under an ability.
- In a contest, the highest successful roll wins.

**COMBAT**  
The attacker rolls their weapon die, equal to or under an **Ability**.
When successful, subtract the roll from the target's **Armour**, then deal the remaining total as harm to their **Grit**.
...
If an attack is **impaired**, the attacker roll *1d4*, regardless of weapon.
**Unarmed** attacks are always considered **impaired**.
If the attack is **enhanced**, the attacker rolls *1d12*.
Attacks with the **blast** quality affect all area targets, rolling separately for each.
...
**HARM**  
Harm that reduces a target's Grit **below** 0 decreases the remainder from their
...
- **death**, if it is **Prowess**.
- **condition**, if it is **Insight**.
- **panic**, if it is **Resolve**.

**HEALING**  
After a few hours' rest and a meal you re-roll your **Grit**.
**Deprived** PCs roll *-1d6* **Grit** when resting.

**Ability** loss recovers at a rate of one per day, and requires a skilled healer.
