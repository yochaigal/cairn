...
First, remember that treasure doesn't need to be treasure. It can be:
...
Second, treasure tells a story, too.  Cover your treasure in religious symbols, anoint it in trollblood.  Don't let your coins be coins!

### 2. Something to be killed
This is pretty obvious.  Of course there are threatening things in the dungeon.  There has to be some challenge otherwise it isn't a dungeon.  The simplest way to do that is with things that are trying to kill you.  
...
- Dungeons need to feel like they were designed to be unbeatable.
...
- I think that nearly all combats should be escapable. Sometimes with a cost (dropped food, gold, maybe a dead PC or hireling). In my experience PCs will get themselves killed often enough even if the enemies never left the rooms they were in.
...
### 4. Different Paths
- Different paths allow different parties to experience the dungeon in different ways.  It's a randomizer, similar to what you'd get if you ordered the dungeon rooms according to a random number generator.
...
- At the same time, don't throw in random paths just for the hell of it.  The more paths you put in, the less linearity there is in your dungeon.  And sometimes you want linearity, especially when it comes to teaching your players things, or giving clues.
...
- Graveyard nymph.
-  Make a sympathetic one.  Everyone expects them to be jerks.
...
Aside from something that will probably kick the party's ass, I think this might be the most OSR-ish. These are the unexplainable, the weird, and the unknown.  And I don't mean unknown like an unidentified potion is unknown.  I mean something that introduces a new wrinkle into the game.
...
Why put stuff in your dungeon that your players won't find?
