...
In this , Esme has made a series of decisions that quickly spiraled out of control: the choice to take the Heartseed despite her friend's warnings,  ignoring the crows,  disregarding the visions pleading with her to return it, and then finally the decision to ingest the seed itself. 
