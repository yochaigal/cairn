...
The party (3 healthy PCs walking by foot) are plotting a journey to an ancient ruin deep in the forests of **Ein Eyton**. The forest is separated from the party's present location (the village of **Rudbat**) by the neighboring **Range of Deshe**, a short distance away. The **Warden** explains that travelling on the forgiving roads from the village to the hills will require only a single **phase**, but that it will take three _additional_ **phases** for the party to complete their journey to the forest, assuming they spend one **phase** sleeping. 
