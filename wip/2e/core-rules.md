...
- If two characters need to take an action together, whomever is most at risk should make the save (usually the character with the lowest relevant Attribute).
