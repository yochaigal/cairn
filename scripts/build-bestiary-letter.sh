...
pdflatex -output-directory=$tmpdir $tmpdir/cairn-bestiary.tex
pdfjam --letterpaper --booklet true --landscape "$tmpdir/cairn-bestiary.pdf" -o "$tmpdir/cairn-bestiary-booklet.pdf" --preamble '\usepackage{everyshi} \makeatletter \EveryShipout{\ifodd\c@page\pdfpageattr{/Rotate 180}\fi} \makeatother'
